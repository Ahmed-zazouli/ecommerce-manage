      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1">
              ...
              <li class="menu-item">
                <a href={{ route('work_flows.index') }} class="menu-link">
                  <i class="menu-icon tf-icons bx bx-collection"></i>
                  <div data-i18n="Basic">Work Flow</div>
                </a>
              </li>
            <!-- components -->
             ...
             <!-- <li class="menu-header small text-uppercase"><span class="menu-header-text">Forms &amp; Tables</span></li>-->
              ...
              <li class="menu-item">
                ...
                <ul class="menu-sub">
                  <li class="menu-item">
                    <a href={{ route('basic_inputs') }} class="menu-link">
                      <div data-i18n="Basic Inputs">Basic Inputs</div>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a href={{ route('input_groups') }} class="menu-link">
              ...
              <li class="menu-item">
                ...
                <ul class="menu-sub">
                  <li class="menu-item">
                    <a href={{ route('vertical_form') }} class="menu-link">
                      <div data-i18n="Vertical Form">Vertical Form</div>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a href={{ route('horizontal_form') }} class="menu-link">
              ...
              <!-- Tables -->
              <li class="menu-item">
                <a href={{ route('tables') }} class="menu-link">
                  <i class="menu-icon tf-icons bx bx-table"></i>
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            ...
                            <small class="text-muted">{{  Auth::user()->user_type->type }}</small>
                          </div>
                        </div>
                      </a>
                    </li>
                    ...
                    <li>
                      <a class="dropdown-item" href="{{route('users.my_profile', Auth::user())}}">
