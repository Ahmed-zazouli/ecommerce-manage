        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            ...
            <ul class="list-unstyled mb-4 mt-3">
             ...
             <li class="d-flex align-items-center mb-3"><i class="bx bx-calendar-alt"></i><span class="fw-semibold mx-2">Joined At :</span> <span>{{ date('d-m-Y', strtotime( $user->created_at)) }}</span></li>
