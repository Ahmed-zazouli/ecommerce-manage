        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="name" value="{{ $product->name }}" name="name" placeholder="John Doe" />
              </div>
              <div class="mb-3">
                <label class="form-label" for="SKU">SKU</label>
                <input type="text" class="form-control" id="SKU" value="{{ $product->SKU }}" name="SKU" placeholder="HADGZRBHE58" />
              </div>
              <div class="mb-3">
                ...
                <select class="form-select" id="exampleFormControlSelect1" aria-label="Default select example"   id="discount" name="discount_id">
                  <option value="{{ $product->discount_id }}" selected>Open this select menu</option>
              ...
              <div class="mb-3">
                ...
                <div class="input-group input-group-merge">
                    ...
                    <select class="form-select" id="exampleFormControlSelect1" aria-label="Default select example"  id="product_categorie" name="product_categorie_id">
                        <option value="{{ $product->product_categorie_id }}"  selected>Open this select menu</option>
